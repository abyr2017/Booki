...
<!--*******************-->
		...
		<div class="bottom-grid1">
					...
					<div class="fit1">
						<h3>WHEN I GOT MY LIBRARY CARD THAT4S WHEN MY LIFE BEGAN</h3>
...
<div class="footer">
		<div class="container">
			...
			<div class="clearfix"> </div>
			<p class="footer-class">Copyrights © 2015 I Wear. All rights <?php session_start(); ?>
			                ...
			                while($row = $result->fetch_array()) {
			                  echo "<div class='grid-chain-bottom'>" .
			                          ...
			                          "<div class='star-price'>
										...
										<div class='cart-add'>
											<a class='add1 item_ad' href='#'>ADD TO MY MY BOOKSHELF <i> </i></a>
											<a class='add2' href='#'><i class='glyphicon glyphicon-heart-empt'> </i></a>
											<div class='clearfix'> </div>
										</div>
				   		     		</div>
